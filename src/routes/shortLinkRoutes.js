...
router.post(
  ...
  [
    ...
    body("targetId")
      .optional()
      .isMongoId()
      .withMessage("ID target tidak valid"),
    body("customUrl")
      .optional()
      .isString()
      .withMessage("URL kustom harus berupa string"),
    body("expiresAt")
      .optional()
      .isISO8601()
      .withMessage("Format tanggal kadaluarsa tidak valid"),
  ],
  createNewShortLink
);
...
router.get("/admin/stats", verifyAdmin, getShortLinkStats);
